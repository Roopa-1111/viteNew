...
function storeUserDataInFirebase(name, email, age) {
  // Get a reference to the Firebase Realtime Database
  const databaseRef = firebase.database().ref();
  
  // Create a new child node under the "users" node, with a unique key generated by calling `push()`
  const userRef = databaseRef.child('users').push();
